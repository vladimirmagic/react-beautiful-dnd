...
var config = {
  ...
  maxPixelScroll: 28,
  startLeftFromPixels: 0,
  startRightFromPixels: 0,
  overlapPixels: 0,
...
var getScrollOnAxis = (function (_ref) {
  ...
  var thresholds = getDistanceThresholds(container, axis, isCloserToEnd, contentBox);
...
var scroll$1 = (function (_ref) {
  ...
  var contentBox = draggable.page.contentBox;
...
function useMouseSensor$1(api) {
  ...
  var bindCapturingEvents = useMemoOne.useCallback(function bindCapturingEvents(event) {
    var options = {
      capture: true,
      passive: false
    };
  ...
  var startPendingDrag = useMemoOne.useCallback(function startPendingDrag(actions, point, event) {
...
function useDroppablePublisher(args) {
  ...
  var getNewClientWhileDragging = useMemoOne.useCallback(function () {
    var previous = previousRef.current;
    var ref = previous.getDroppableRef();
    !ref ? process.env.NODE_ENV !== "production" ? invariant(false, 'Cannot collect without a droppable ref') : invariant(false) : void 0;
    var env = getEnv(ref);
